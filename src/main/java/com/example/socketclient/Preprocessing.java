...
//        File stdFile = new File("stdMatrix");
        try(InputStream meanInputStream = new FileInputStream("/Users/kd639/OneDrive/바탕 화면/rule-based-inference (2)/src/main/resources/meanMatrix");
            InputStream stdInputStream = new FileInputStream("/Users/kd639/OneDrive/바탕 화면/rule-based-inference (2)/src/main/resources/stdMatrix");
